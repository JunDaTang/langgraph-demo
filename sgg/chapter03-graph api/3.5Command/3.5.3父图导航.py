...
# 初始状态: {'messages': [('user', '开始任务')], 'task_status': 'init', 'subtask_result': ''}
# 执行节点: main_controller (父图)
# 执行节点: data_processor (子图)
# 处理结果: 处理后的数据
# 执行节点: task_finisher (父图)
# 最终状态: {'messages': [('user', '开始任务'), ('system', '启动子任务'), ('subtask', '子任务完成: 处理后的数据'), ('system', '任务完成')], 'task_status': 'completed', 'subtask_result': '处理后的数据'}
